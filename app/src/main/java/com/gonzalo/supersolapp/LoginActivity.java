...
import static com.gonzalo.supersolapp.controllers.Constant._URL_AUTENTIFICACION;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                url = new URL(_URL_AUTENTIFICACION);
            ...
            try {
                ...
                Uri.Builder builder = new Uri.Builder()
                        .appendQueryParameter("login", mEmail).appendQueryParameter("password", mPassword);
        ...
        protected void onPostExecute(Void aVoid) {
            mAuthTask = null;
            showProgress(false);
            Log.d("LogIn ASYNC", "dato: " + resultado);
            try {
                JSONObject group_info = new JSONObject(String.valueOf(resultado));
                JSONArray codigo_respuesta = group_info.getJSONArray("auth");
                showProgress(false);
                for (int i = 0; i < codigo_respuesta.length() ; i++) {
                    ...
                    switch (response) {
                        case 0:
                            // NO tiene acceso
                            Toast.makeText(mContext, "Usuario sin Acceso", Toast.LENGTH_SHORT).show();
                            break;
                        default:
